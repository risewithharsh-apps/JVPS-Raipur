...
export const CONTENT: SiteContent = {
  en: {
    thankYou: "Thank You!",
    reachOut: "We have received your details and our team will reach out to you shortly.",
    title: "Jeevan Vidya Parichay Shivir",
    subtitle: "A journey towards understanding life, harmony, and co-existence.",
    dates: "18th – 25th Jan",
    location: "Raipur, Chhattisgarh",
    venueName: "Vimtara Bhawan, Raipur",
    ...
    contactTitle: "Need assistance? Reach out to us",
    contacts: [
      { name: "Rakesh", phone: "7506336797" },
      { name: "Harsh", phone: "9770978900" }
    ]
  },
  hi: {
    thankYou: "धन्यवाद!",
    reachOut: "हमें आपका विवरण मिल गया है और हमारी टीम जल्द ही आपसे संपर्क करेगी।",
    title: "जीवन विद्या परिचय शिविर",
    subtitle: "जीवन, सद्भाव और सह-अस्तित्व को समझने की एक यात्रा।",
    dates: "18 – 25 जनवरी",
    location: "रायपुर, छत्तीसगढ़",
    venueName: "विमतरा भवन, रायपुर",
    ...
    contacts: [
      { name: "राकेश", phone: "7506336797" },
      { name: "हर्ष", phone: "9770978900" }
    ]
  }
};

export const YOUTUBE_VIDEO_ID = "dJiea81IAVY";
